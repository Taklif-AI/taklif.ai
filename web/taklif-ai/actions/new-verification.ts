...
import { getUserByEmail, updateUserFields } from "@/data/user";
...
export const newVerification = async (token: string) => {
    ...
    await updateUserFields(existingUser.pk, 'emailVerified', new Date().toISOString(), 'email', existingToken.email);
