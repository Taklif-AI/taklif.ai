...
function TeamMemberCard({ member }: { member: TeamMember }) {
  return (
    <Card className="p-4 sm:p-6 transition-all duration-300 bg-gradient-to-br from-white to-violet-50/30 dark:from-gray-900 dark:to-violet-950/20 hover:bg-violet-50 dark:hover:bg-violet-900/20 hover:shadow-lg dark:hover:shadow-violet-900/50">
...
export function HomeTeam() {
  return (
    <section className="py-12 sm:py-16 lg:py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-white to-violet-50 dark:from-background dark:to-violet-950/20">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-8 sm:mb-12 lg:mb-16">
          <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold mb-4 bg-gradient-to-r from-violet-600 to-violet-400 bg-clip-text text-transparent">
            Meet Our Team
          </h2>
