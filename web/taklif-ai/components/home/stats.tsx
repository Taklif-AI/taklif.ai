...
export function HomeStats() {
  return (
    <section className="relative py-20 px-4 sm:px-6 lg:px-8 overflow-hidden">
      ...
      >
        <div
          className="relative right-[calc(50%-11rem)] aspect-[1155/678] w-[36.125rem] -translate-x-1/2 rotate-[30deg] bg-gradient-to-tr from-violet-200 to-violet-100 opacity-20 sm:right-[calc(50%-30rem)] sm:w-[72.1875rem]"
          style={{
            clipPath:
      ...
      <div className="relative max-w-7xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          {stats.map((stat, index) => (
            <Card
              key={index}
              className="p-6 relative overflow-hidden group hover:scale-105 transition-all duration-300 bg-white/50 dark:bg-gray-950/50 backdrop-blur-sm"
            >
              <div
              ...
              <div className="relative z-10">
                <div
                  className={`p-3 rounded-lg w-12 h-12 mb-4 flex items-center justify-center bg-gradient-to-br ${stat.color} text-white`}
                >
