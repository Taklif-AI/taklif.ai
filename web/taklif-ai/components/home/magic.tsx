...
4. Conclusion
  ...
  return (
    <div id="magic" className="container mx-auto p-6">
      <div>
        <motion.div
...
<motion.div
        ...
        >
      <div className="flex flex-col lg:flex-row gap-8 max-w-6xl mx-auto bg-card rounded-lg overflow-hidden shadow-xl border">
        {/* Left Panel */}
        <div className="lg:w-1/3 bg-gradient-to-br from-violet-600 to-purple-700 p-8 relative">
          ...
          <div className="flex justify-center mt-[22rem] mb-8 space-x-2">
            {[1, 2, 3].map((step) => (
              <div
                key={step}
          ...
          <Button
            ...
            disabled={(currentStep === 1 && !selectedAssignment) || 
                     (currentStep === 2 && !selectedInterest)}
            className="bg-white text-purple-600 hover:bg-white/90 disabled:opacity-50 disabled:cursor-not-allowed"
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {interests.map((interest, index) => {
                ...
                return (
                  <Card
                    key={index}
                    className={`p-6 hover:bg-accent cursor-pointer transition-all hover:scale-[1.02] flex flex-col items-center justify-center space-y-3 ${
                      selectedInterest === interest.name ? "ring-2 ring-purple-500" : ""
                    }`}
