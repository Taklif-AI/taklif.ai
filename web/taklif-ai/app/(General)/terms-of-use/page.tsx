          ...
          <div className="prose prose-invert max-w-none space-y-6">
            <section className="bg-purple-900/5 p-6 rounded-lg border border-purple-500/5">
              ...
              <ol className="list-decimal pl-6 text-gray-800 dark:text-gray-300 space-y-2">
                <li>
                  <a href="#our-services" className="hover:underline text-gray-800 dark:text-gray-300">
                    OUR SERVICES
                  </a>
                </li>
                <li>
                  <a href="#intellectual-property-rights" className="hover:underline text-gray-800 dark:text-gray-300">
                    INTELLECTUAL PROPERTY RIGHTS
                  </a>
                </li>
                <li>
                  <a href="#user-representations" className="hover:underline text-gray-800 dark:text-gray-300">
                    USER REPRESENTATIONS
                  </a>
                </li>
                <li>
                  <a href="#user-registration" className="hover:underline text-gray-800 dark:text-gray-300">
                    USER REGISTRATION
                  </a>
                </li>
                <li>
                  <a href="#prohibited-activities" className="hover:underline text-gray-800 dark:text-gray-300">
                ...
                <li>
                  <a href="#contribution-license" className="hover:underline text-gray-800 dark:text-gray-300">
                ...
                <li>
                  <a href="#services-management" className="hover:underline text-gray-800 dark:text-gray-300">
                    SERVICES MANAGEMENT
                  </a>
                </li>
                <li>
                  <a href="#privacy-policy" className="hover:underline text-gray-800 dark:text-gray-300">
                    PRIVACY POLICY
                  </a>
                </li>
                <li>
                  <a href="#term-and-termination" className="hover:underline text-gray-800 dark:text-gray-300">
                ...
                <li>
                  <a href="#corrections" className="hover:underline text-gray-800 dark:text-gray-300">
                    CORRECTIONS
                  </a>
                </li>
                <li>
                  <a href="#disclaimer" className="hover:underline text-gray-800 dark:text-gray-300">
                    DISCLAIMER
                  </a>
                </li>
                <li>
                ...
                <li>
                  <a href="#indemnification" className="hover:underline text-gray-800 dark:text-gray-300">
                    INDEMNIFICATION
                  </a>
                </li>
                <li>
                  <a href="#user-data" className="hover:underline text-gray-800 dark:text-gray-300">
                    USER DATA
                  </a>
                </li>
                <li>
                ...
                <li>
                  <a href="#miscellaneous" className="hover:underline text-gray-800 dark:text-gray-300">
                    MISCELLANEOUS
                  </a>
                </li>
                <li>
                  <a href="#contact-us" className="hover:underline text-gray-800 dark:text-gray-300">
                    CONTACT US
                  </a>
                </li>
              </ol>
              ...
              <p className="text-gray-800 dark:text-gray-300">
                We are Taklif.AI (<strong className="text-gray-800 dark:text-gray-300">"Company," "we," "us," "our"</strong>).
              </p>
              <p className="text-gray-800 dark:text-gray-300">
                We operate the website{" "}
                <strong className="text-gray-800 dark:text-gray-300">https://taklif-ai.tech</strong> (the{" "}
                <strong className="text-gray-800 dark:text-gray-300">"Site"</strong>), as well as any other related products
                and services that refer or link to these legal terms (the{" "}
                <strong className="text-gray-800 dark:text-gray-300">"Legal Terms"</strong>) (collectively, the{" "}
                <strong className="text-gray-800 dark:text-gray-300">"Services"</strong>).
              </p>
              <p className="text-gray-800 dark:text-gray-300">
                AI-Powered Interest-Based Personalized Assignments. Create
                personalized assignments customized to match your out-of-school
                interests, making assignments more engaging, relevant, and
                impactful for your academic and professional growth.
              </p>
              <p className="text-gray-800 dark:text-gray-300">
              ...
              <p className="text-gray-800 dark:text-gray-300">
                ...
                <strong className="text-gray-800 dark:text-gray-300">"you"</strong>), and Taklif.AI, concerning your access
              ...
              <p className="text-gray-800 dark:text-gray-300">
                ...
                <strong className="text-gray-800 dark:text-gray-300">"Last updated"</strong> date of these Legal Terms, and
              ...
              <p className="text-gray-800 dark:text-gray-300">
                ...
                <strong className="text-gray-800 dark:text-gray-300">"Content"</strong>), as well as the trademarks, service
                marks, and logos contained therein (the{" "}
                <strong className="text-gray-800 dark:text-gray-300">"Marks"</strong>).
              </p>
              <p className="text-gray-800 dark:text-gray-300">
              ...
              <p className="text-gray-800 dark:text-gray-300">
                ...
                <strong className="text-gray-800 dark:text-gray-300">"AS IS"</strong> for your personal, non-commercial use
                only.
              </p>
              <p className="text-gray-800 dark:text-gray-300 font-semibold">
              ...
              <p className="text-gray-800 dark:text-gray-300">
                ...
                <strong className="text-gray-800 dark:text-gray-300">"PROHIBITED ACTIVITIES"</strong> section below, we grant
              ...
              <p className="text-gray-800 dark:text-gray-300">
                ...
                <strong className="text-gray-800 dark:text-gray-300">"PROHIBITED ACTIVITIES"</strong> section carefully prior
              ...
              <p className="text-gray-800 dark:text-gray-300">
                <strong className="text-gray-800 dark:text-gray-300">Submissions:</strong> By directly sending us any
                question, comment, suggestion, idea, feedback, or other
                information about the Services (
                <strong className="text-gray-800 dark:text-gray-300">"Submissions"</strong>), you agree to assign to us all
              ...
              <p className="text-gray-800 dark:text-gray-300">
                <strong className="text-gray-800 dark:text-gray-300">You are responsible for what you post or upload:</strong>{" "}
                By sending us Submissions through any part of the Services you:
              </p>
              <ul className="list-disc pl-6 text-gray-800 dark:text-gray-300 space-y-2">
                <li>
                  confirm that you have read and agree with our{" "}
                  <strong className="text-gray-800 dark:text-gray-300">"PROHIBITED ACTIVITIES"</strong> and will not post,
              ...
              <p className="text-gray-800 dark:text-gray-300">
                ...
                <strong className="text-gray-800 dark:text-gray-300">"Contributions"</strong>). Contributions may be
                ...
                in accordance with the Services' Privacy Policy. When you create
              ...
              <p className="text-gray-800 dark:text-gray-300">
                ...
                Privacy Policy:{" "}
                <strong className="text-gray-800 dark:text-gray-300">taklif-ai.tech/privacy-policy</strong>. By using the
                Services, you agree to be bound by our Privacy Policy, which is
                incorporated into these Legal Terms. Please be advised the
                Services are hosted in Sweden. If you access the Services from
                any other region of the world with laws or other requirements
                governing personal data collection, use, or disclosure that
                differ from applicable laws in Sweden, then through your
                continued use of the Services, you are transferring your data to
                Sweden, and you expressly consent to have your data transferred
                to and processed in Sweden.
              </p>
