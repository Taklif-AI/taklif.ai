...
export default function TermsOfUse() {
  return (
    <div className="min-h-screen bg-white dark:bg-[#13111C] py-20">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="space-y-8">
          <div className="text-center">
            <h1 className="text-4xl font-bold text-black dark:text-white mb-4">Terms of Use</h1>
            <p className="text-gray-600 dark:text-gray-400">Last updated: January 11, 2024</p>
          </div>
          ...
          <div className="prose prose-invert max-w-none space-y-6">
            <section className="bg-purple-900/10 p-6 rounded-lg border border-purple-500/20">
              ...
              <p className="text-gray-800 dark:text-gray-300">Users must not:</p>
              <ul className="list-disc pl-6 text-gray-800 dark:text-gray-300 space-y-2">
