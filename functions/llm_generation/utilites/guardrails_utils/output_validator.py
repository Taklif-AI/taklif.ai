...
@register_validator(name="guardrails/output_validator", data_type="string")
class OutputValidator(Validator):
    def __init__(
        ...
        **kwargs,
        ...
        self.rail_alias = "output_validator"
    ...
    def _inference_remote(self, metadata: dict, personalized_assignment: str) -> bool:
        ...
        """
        interest_guardrail_prompt = metadata['langsmith_client'].pull_prompt(prompt_identifier = "output-guardrails-prompt")
        prompt = interest_guardrail_prompt.format(personalized_assignment=personalized_assignment)
